<footer class="bg-gray-800 py-20 mt-20">
    <div class="sm:grid grid-cols-3 w-4/5 pb-10 m-auto border-b-2 border-gray-700">
        ...
        <div>
            ...
            <ul class="py-4 sm:text-s pt-4 text-gray-400">
                <li class="pb-1">
                    <a href="/">
                        Why become an F1 blogger
                    </a>
                </li>
                <li class="pb-1">
                    <a href="/">
                        Why use this web page
                    </a>
                </li>
                <li class="pb-1">
                    <a href="/">
                        Why become an F1 fan
                    </a>
                </li>
                <li class="pb-1">
                    <a href="/">
                        Why David Jelenc is the best assistant
                    </a>
                </li>
            </ul>
        </div>
    ...
    <p class="w-25 w-4/5 pb-3 m-auto text-xs text-gray-100 pt-6">
        Copyright 2022-2028 Jan Martin Hozjan. All rights reserved.
    </p>
</footer><?php /**PATH C:\xampp\htdocs\blog_dn3\resources\views/layouts/footer.blade.php ENDPATH**/ ?>